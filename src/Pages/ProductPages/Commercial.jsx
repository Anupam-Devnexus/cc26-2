...
export default function Commercial() {
    ...
    return (
        <>
            <ProductHeader
                text={"Commercial Brick"}
                image={"https://images.pexels.com/photos/207142/pexels-photo-207142.jpeg?auto=compress&cs=tinysrgb&w=600"}
                desc={"Commercial Bricks are specially manufactured clay bricks designed for commercial construction projects such as office buildings, shopping complexes, schools, and industrial structures. Known for their durability, uniform shape, and aesthetic appeal, these bricks offer both strength and a clean, professional look. They are often engineered to meet higher load-bearing standards, making them ideal for large-scale developments. Commercial bricks are also available in various finishes and colors, allowing architects and developers to achieve both functionality and design consistency."}
            />

            <BrickFilter filters={filters} onFilterChange={setFilters} title={"Bricks"} />
